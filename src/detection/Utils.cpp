...
drawRegtangle (cv::Mat image,
               ...
               int height)
{
  cv::Point2f top_left_point (centerPoint.x - width / 2, centerPoint.y - height / 2);
  cv::Rect2f reg (top_left_point.x, top_left_point.y, width, height);

  cv::rectangle (image, reg, color, 1, 0);
...
// Draw a text with frameID
void
drawText3 (cv::Mat image,
           std::string text,
           cv::Scalar color)
{
  cv::putText (image, text, cv::Point (420, 50), fontFace, fontScale, color, thickness_font, 8);
}

// Draw found descriptor
void
drawText4 (cv::Mat image,
           std::string text,
           cv::Scalar color)
{
  cv::putText (image, text, cv::Point (420, 75), fontFace, fontScale, color, thickness_font, 8);
}
...
drawText5 (cv::Mat image,
           ...
           cv::Scalar color)
{
  cv::putText (image, text, cv::Point (25, 400), fontFace, fontScale, color, thickness_font, 8);
}
...
drawText6 (cv::Mat image,
           ...
           cv::Scalar color)
{
  cv::putText (image, text, cv::Point (25, 425), fontFace, fontScale, color, thickness_font, 8);
}
         ...
         cv::Scalar color)
{
  ...
  cv::putText (image, text, cv::Point (420, 125), fontFace, fontScale, color, thickness_font, 8);
}
                ...
                cv::Scalar color)
{
  ...
  cv::putText (image, text, cv::Point (420, 100), fontFace, fontScale, color, thickness_font, 8);
}
...
{
  // Draw Selected points
  cv::circle (image, point, radius, color, -1, lineType);
}
