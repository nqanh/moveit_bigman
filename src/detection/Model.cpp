...
void
Model::add_correspondence (const cv::Point2f &point2d,
...
void
Model::add_outlier (const cv::Point2f &point2d)
{
  list_points2d_out_.push_back (point2d);
}

void
Model::add_descriptor (const cv::Mat &descriptor)
{
  descriptors_.push_back (descriptor);
}

void
Model::add_keypoint (const cv::KeyPoint &kp)
{
...
void
Model::save (const std::string path)
{
